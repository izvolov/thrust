...
1.  [Что интересного?](#что-интересного)
    1.  [Integer sort](#целочисленные-сортировки)
    2.  [Dynamic tuples](#динамический-кортеж)
    3.  [Lazy range calculations](#ленивые-вычисления-над-диапазонами)
2.  [Requrements](#reqirements)
3.  [Installation](#install)
    1.  [Way 1: Copy source files](#вариант-1-скопировать-исходники)
    2.  [Way 2: Install with CMake](#вариант-2-установить-с-помощью-cmake)
    3.  [Way 3: Add source folder into CMake](#вариант-3-подключить-папку-с-проектом-в-cmake)
    4.  [Way 4: CMake FetchContent](#вариант-4-cmake-fetchcontent)

Что интересного?
----------------

Полный список интересных штук можно изучить в [справочнике](doc/README.en.md).

### Целочисленные сортировки

Алгоритмы сортировок стандартной библиотеки `std::sort` и `std::stable_sort` являются классическими представителями сортировок, основанных на сравнениях. В то же время время существует другой класс алгоритмов, применимый к целым числам и не использующий в своей работе сравнения. Таким алгоритмом является [radix sort](https://https://en.wikipedia.org/wiki/Radix_sort). И, хотя это такой же классический алгоритм, как, например, быстрая сортировка или сортировка подсчётом, реализации поразрядной сортировки, как правило, оставляют желать лучшего. Возможно, поэтому многие люди до сих пор считают поразрядку алгоритмом, представляющим исключительно академический интерес, и малоприменимым в реальности. Однако, это заблуждение.
...
![Integer sorts comparision](doc/images/radix_sort_is_fast.png)

[More about `burst::radix_sort` and `burst::counting_sort`](doc/README.en.md#intsort).
...
[More about `burst::dynamic_tuple`](doc/README.en.md#dynamic-tuple).

### Lazy range calculations
...
1.  [Join](doc/README.en.md#join)
2.  [Merge](doc/README.en.md#merge)
3.  [Intersection](doc/README.en.md#intersect)
4.  [Semi-intersection](doc/README.en.md#semiintersect)
5.  [Union](doc/README.en.md#union)
6.  [Difference](doc/README.en.md#difference)
7.  [Symmetric Difference](doc/README.en.md#symmetric-difference)

[More about lazy range calculations](doc/README.en.md#lazy-ranges).

Требования
----------

1.  Build system [CMake](https://cmake.org/) min version 3.8.2;
2.  Compiler [GCC](https://gcc.gnu.org/) min version 6.2 or [Clang](http://clang.llvm.org/) version 3.9+ \*;
3.  Units tests [doctest](https://github.com/onqtam/doctest) \[optional\*\*\];
4.  Libraries [Boost](https://www.boost.org/) (module [`program_options`](https://www.boost.org/doc/libs/1_62_0/doc/html/program_options.html) \[optional\*\*\*\]) version 1.62+;
5.  [Doxygen](http://doxygen.nl) \[optional\].
